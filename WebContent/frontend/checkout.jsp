...
<title>Checkout - Online Magazine Store</title>
				...
				<div>
					...
					<div>
						<table class="normal">
							<tr><td>&nbsp;</td></tr>
							<tr>								
								<td><button type="submit">Conferma Abbonamento</button></td>								
								<td><a href="${pageContext.request.contextPath}/">Continua gli acquisti</a></td>
