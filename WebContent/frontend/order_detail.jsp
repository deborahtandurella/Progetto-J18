...
<head>
	...
	<title>Dettagli Abbonamenti</title>
...
<body>
	...
	<%-- <c:if test="${order == null}">
		<div align="center">
			<h2 class="pageheading">Non sei autorizzato a vedere quest'ordine</h2>
		<div align="center">
	</c:if> --%>
	
	<c:if test="${order != null}">
	<div align="center">
		<h2 class="pageheading">Numero Ordine: ${order.ordineId}</h2>		
	</div>
	...
	<div align="center">
		...
		<table border="1">
			...
			<tr>
				...
				<td>${orderDetail.rivista.price} &euro;</td>
