...
public class OrderDAO extends JpaDAO<RivistaOrder> implements GenericDAO<RivistaOrder> {
	...
	public long countOrderDetailByRivista(int rivistaId) {
		return super.countWithNamedQuery("DettagliOrdine.countByRivista", "rivistaId", rivistaId);
	}
	
	public long countByCustomer(int clienteId) {
		return super.countWithNamedQuery("RivistaOrder.countByCustomer", "clienteId", clienteId);
	}
